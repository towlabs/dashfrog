...
export function AddFilterDropdown({
	...
	const freeTextOperators: FilterOperator[] = [
		"contains",
		"starts_with",
		"less_than",
		"greater_than",
	...
	const valueOptions =
		selectedColumn && getValueOptions
			? getValueOptions(selectedColumn)
			: undefined;
			...
			<DropdownMenu open={dropdownOpen} onOpenChange={setDropdownOpen}>
				<DropdownMenuTrigger asChild>
					<Button
						variant="ghost"
						size="sm"
						className="h-8 px-2 border-0 bg-transparent text-muted-foreground"
					>
				...
				<DialogContent className="sm:max-w-[425px]">
					...
					<div className="grid gap-4 py-4">
						...
						<div className="space-y-2">
							...
							{freeTextOperators.includes(operator) ||
							!valueOptions ||
