...
export function FilterTag({
	...
	const freeTextOperators: Filter["operator"][] = [
		"contains",
		"starts_with",
		"less_than",
		"greater_than",
				...
				>
					<div className="space-y-4">
									...
									>
										{
											operatorOptions.find(
												(option) => option.value === tempOperator,
											)?.label
										}
												...
												{operatorOptions.map((option) => (
													<CommandItem
														...
														onSelect={(currentValue) => {
															setTempOperator(
																currentValue as Filter["operator"],
															);
						...
						<div>
							...
							{freeTextOperators.includes(tempOperator) ||
							!valueOptions ||
