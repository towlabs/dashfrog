			...
			{showLockConfirmation && (
				<div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
					<div className="bg-background border rounded-lg p-6 max-w-md mx-4 shadow-lg">
						<h2 className="text-lg font-semibold mb-2">Unsaved Changes</h2>
						<p className="text-sm text-muted-foreground mb-4">
							You have unsaved changes. Do you want to save them before locking
							the notebook?
						</p>
						<div className="flex gap-3 justify-end">
							<Button
							...
							<Button onClick={handleLockConfirmation}>Save and Lock</Button>
						</div>
					</div>
				</div>
			)}
					...
					{!isView && (
						<div className="flex items-center gap-3">
							...
							{hasUnsavedChanges && !showSavedIndicator && (
								<div className="bg-yellow-500/10 border border-yellow-500/50 text-yellow-700 dark:text-yellow-400 px-3 py-1.5 rounded-md flex items-center gap-2 text-sm">
							...
							{showSavedIndicator && (
								<div className="bg-green-500/10 border border-green-500/50 text-green-700 dark:text-green-400 px-3 py-1.5 rounded-md flex items-center gap-2 text-sm">
